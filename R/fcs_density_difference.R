                                          ...
                                          add_timestamp = TRUE, hull_concavity = 2)
{
  ...
  if (!require(ggforce, quietly = TRUE)) stop("Package 'ggforce' is required but could not be loaded."); if (!require(concaveman, quietly = TRUE)) stop("Package 'concaveman' is required but could not be loaded.")
